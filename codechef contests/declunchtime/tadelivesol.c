...
/*  Function Name: countSort()
    Input : A[] - Array to sort
           ...
           end - end index of subarray to sort
    Output : The sorted sequence A
    Description : The function implements the quick sort algorithm
*/
...
/*  Function Name: random_quickSort()
    Input : A[] - Array to sort
           start -start index of subarray to sort
           end - end index of subarray to sort
    Output : The sorted sequence A
    Description : The function implements the random quick sort algorithm
*/
